...
@section('content')
    <div class="card shadow-sm border-0">
        <div class="card-header bg-white">
            ...
            <a class="mb-0 btn btn-sm btn-outline-success " href="{{route('create.users')}}">+ Creer utilisateur</a>
        </div>
        <div class="card-body">
                            ...
                            <td>
                                <div class="dropup">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <a class="dropdown-item " href="{{ route('show.users', $user->id) }}">
                                                <i class="fa-solid fa-eye me-1 text-success"></i> Voir
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item " href="{{ route('edit.users', $user->id) }}">
