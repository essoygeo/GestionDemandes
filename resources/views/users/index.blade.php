...
@section('content')
    <div class="card shadow-sm border-0">
        <div class="card-header bg-white">
            ...
            <a class="mb-0 btn btn-sm btn-outline-violet " href="{{route('create.users')}}">+ Creer utilisateur</a>
        </div>
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-hover  align-middle" id="dataTable">
                    ...
                    <tr>
                        ...
                        <th class="text-primary-emphasis">Rôle</th>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <a class="dropdown-item violet" href="{{ route('show.users', $user->id) }}">
                                                <i class="fa-solid fa-eye me-1 violet"></i> Voir
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item violet" href="{{ route('edit.users', $user->id) }}">
